...
class RplusWpTopContentAdmin {
    ...
    public function add_plugin_admin_options() {
        ...
        register_setting( $this->plugin_slug . '-options', 'rplus_topcontent_options_ga_' );

        add_settings_section(
            'rplus_topcontent_options_ga',
            __( 'Google Analytics', 'required-wp-top-content' ),
            function() {
                _e( 'Infos pls', 'required-wp-top-content' );
            },
            $this->plugin_slug
        );

        add_settings_field(
            'rplus_topcontent_options_ga_',
            __( 'Google Analytics API', 'required-wp-top-content' ),
            function() {
                echo "yadda";
            },
            $this->plugin_slug,
